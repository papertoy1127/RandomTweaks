		...
		public static partial class Patch {
			...
			private static class PlayEditorLevelPatch {
				...
				public static bool Prefix(scnEditor __instance, ref bool ___showingPopup) {
					bool flag = (!(__instance.eventSystem.currentSelectedGameObject != null) ||
					             !(__instance.eventSystem.currentSelectedGameObject.GetComponent<InputField>() !=
					               null)) && !___showingPopup && RandomTweaksPlayingModule.settings.PlayCLSInEditor;
					if (flag) {
